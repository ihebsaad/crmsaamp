...
return [
	...
	'welcome to your saamp page'=>'Witamy w Twojej przestrzeni Saamp',
           ...
           'in grams'=>'w gramach',
            ...
            "Empty"=>"Pusty",
			"Visitor"=>"Gość",
			"Access reserved for logged in users"=>"dostęp zarezerwowany dla zalogowanych użytkowników",
			"Currency"=>"Waluta",
			"Unlettered scripts only"=>"tylko nieliterowane skrypty",
	        "My Saved Metal Discounts"=>"Moje zapisane zniżki na metal",
            "Discount for refining"=>"Rabat na rafinację",
            "My saved refining discounts"=>"Moje zapisane rabaty na udoskonalenia",
            "New discount"=>"Nowy rabat",
            "Discount for the laboratory"=>"Zniżka na laboratorium",
            "My lab discounts saved"=>"Moje rabaty na laboratorium zostały zapisane",
            "Discount metals for sale"=>"Sprzedaż metali ze zniżką",
            "My metal discounts for sale saved"=>"Moje zniżki na metale na sprzedaż zostały zapisane",
            "You can start from a saved discount to create a new one by clicking on its name below"=>"Możesz zacząć od zapisanego rabatu, aby utworzyć nowy, klikając jego nazwę poniżej",
			"Unit"=>"Jednostka",
			"Period"=>"Kropka",
			"View"=>"Pokazać",
			"All"=>"Wszystko",
