...
<style>
 ...
 <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
   ...
   @if($view_name!='adminhome')
   <a class="menu-link hidemobile" href="{{route('adminhome')}}">Accueil</a>
   <a class="menu-link hidemobile" href="{{route('users')}}">Utilisateurs</a>
   @endif
   <div class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown no-arrow">
       <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         <span class="mr-2 d-none d-lg-inline text-white small"> {{$user['name']}} {{$user['lastname'] }}<br></span>
