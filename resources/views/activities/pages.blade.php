        ...
        <div class="card shadow mb-4">
            <div class="  ">
                <a href="#div1" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                    <h6 class="m-0 font-weight-bold text-primary">Dernières pages consultées par {{$user->name}} {{$user->lastname}} - {{$user->client_id}}</h6>
                </a>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <!--<a href="{{ url('export-user-logins') }}" class="btn btn-success">Exporter en EXCEL</a>-->
                    </div>
                </div>
